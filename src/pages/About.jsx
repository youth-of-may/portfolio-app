...
export default function About() {
    ...
    return (
        ...
        <span className="font-semibold">Hi, I’m Princess May Giron! </span> 
       ...
       <p className="mb-4 italic lg:text-lg text-md">
        ...
        <p className="mb-4 italic lg:text-lg text-md">
            I’m always looking for ways to challenge myself, learn new skills, and connect with people who share similar interests.        
        </p>
        </div>
        </div>
        </div>
