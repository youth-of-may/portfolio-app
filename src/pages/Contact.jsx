...
export default function Contact() {
    return (
        ...
        <div className="text-center flex flex-col">
            ...
            <div className="flex flex-wrap mb-4 lg:gap-x-8 py-8 gap-x-2 gap-y-2 border border-gray-400/50 rounded-xl p-4 bg-white hover:drop-shadow-gray-400/30 hover:drop-shadow-lg">
                {socials.map((soc) => 
